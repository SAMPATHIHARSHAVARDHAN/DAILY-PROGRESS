...
DEPARTMENT OF CSE ADS & AA LAB PAGE | 2
...
DEPARTMENT OF CSE ADS & AA LAB PAGE | 3
ROLL NO.: ADITYA COLLEGE OF ENGINEERING & TECHNOLOGY (A)
 // Left Left Case
...
DEPARTMENT OF CSE ADS & AA LAB PAGE | 4
ROLL NO.: ADITYA COLLEGE OF ENGINEERING & TECHNOLOGY (A)
 {
 temp = root;
 root = NULL;
...
void inOrderTraversal(struct TreeNode* root)
{
 if (root != NULL)
 {
DEPARTMENT OF CSE ADS & AA LAB PAGE | 5
ROLL NO.: ADITYA COLLEGE OF ENGINEERING & TECHNOLOGY (A)
...
int main()
{
 ...
 break;
 case 4:
DEPARTMENT OF CSE ADS & AA LAB PAGE | 6
ROLL NO.: ADITYA COLLEGE OF ENGINEERING & TECHNOLOGY (A)
